...
export const Route = createFileRoute("/$countryCode/store")({
  ...
  loader: ({ context, deps, params }) =>
    context.queryClient.ensureQueryData(browseQuery({ countryCode: params.countryCode.toLowerCase(), ...deps })),
...
function StoreRoute() {
  ...
  const countryCode = Route.useParams().countryCode.toLowerCase()

 ...
 *
 * `line` says what the application does, on its own.
 *
 * Four of these were written as a chain — "The same job, for films", "The
 * client the three of them drive", "Finds subtitles for whatever the other two
 * fetched" — which parses only if all eight are read in order and top to
 * bottom. They are read one at a time, in a tooltip, by someone who has
 * hovered a single mark, and there is no "other two" in that reading. Immich's
 * had the opposite problem: it named Google Photos and iCloud and never said
 * what Immich is.
 *
...
const ADDITIONAL: SelfHostedApp[] = [
  ...
  },
  {
    slug: "radarr",
    name: "Radarr",
    line: "Watches for the films you want and fetches them",
  ...
  },
  {
    slug: "qbittorrent",
    name: "qBittorrent",
    line: "Downloads over BitTorrent, with a web interface",
    brand: "#2F67BA",
    wash: "#EEF3F9",
    brandDark: "#6992CD",
    washDark: "#1A283C",
  ...
  },
  {
    slug: "bazarr",
    name: "Bazarr",
    line: "Finds and downloads subtitles automatically",
    /*

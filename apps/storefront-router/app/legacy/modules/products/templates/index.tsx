...
type ProductTemplateProps = {
  ...
  extras?: {
    flowProducts?: Record<string, HttpTypes.StoreProduct>
    services?: HttpTypes.StoreProduct[]
    compatibleParts?: HttpTypes.StoreProduct[]
...
const ProductTemplate = ({
  ...
  if (product.metadata?.["configurator"] === "flow") {
    return <FlowTemplate product={product} countryCode={countryCode} products={extras.flowProducts} />
  }
    ...
    case "machine":
      return (
        <MachineTemplate
          ...
          compatibleParts={extras.compatibleParts}
        />
      )
    case "service":
    ...
    default:
      return (
        <PartTemplate
          ...
          countryCode={countryCode}
          images={images}
          machines={extras.machines}
          sameCategory={extras.sameCategory}
        />
      )
  }
}

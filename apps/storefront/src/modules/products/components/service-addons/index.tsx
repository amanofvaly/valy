import { listProductsOfType } from "@lib/data/products"
 ...
 */
export default async function ServiceAddons({
  countryCode,
}: {
  countryCode: string
}) {
  const services = (await listProductsOfType("service", countryCode, 6)).slice(
    0,
    3
  )

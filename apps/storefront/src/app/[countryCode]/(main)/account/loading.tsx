/**
 * The account area's loading state.
 *
 * A centred spinner said nothing about what was coming. This draws the shape
 * that arrives — the nav rail and a page of rows — so the transition is a fill.
 */

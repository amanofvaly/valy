...
export const metadata: Metadata = {
  ...
  description:
    "Preconfigured homelab servers for Indian homes and offices, plus the drives, memory and cards that fit them. GST invoice, 48-hour burn-in, three-year warranty serviced in India.",
}
